...
The development server is configured to proxy your frappe app (usually running on port `8005`). If you have a site named `todo.test`, open `http://todo.test:8080` in your browser. If you see a button named "Click to send 'ping' request", congratulations!
